       ...
       <div className='container'>
        ...
        <div className='row p-5 mt-5 border-top text-muted' style={{lineHeight:"1.7", fontSize:"1.1em"}}>
            <div className='col-6 p-5'>
                <p>
                We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company StockPulse, a combination of Stocks and "Pulses", the English word for barrier.</p>
            ...
            <div className='col-6 p-5'>
                ...
                <p>
                <a href='' style={{textDecoration:"none"}}>Rainmater</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
                <p>
